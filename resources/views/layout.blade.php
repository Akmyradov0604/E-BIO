			...
			<ul class="navbar-nav ml-auto" style="margin-right: 60px;">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="{{ route('lectures', app()->getLocale()) }}" style="color: #1ED760;">{{__('E-DOC')}}</a>
					</div>
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="{{ route(Route::currentRouteName(), 'en') }}" style="color: #1ED760; ">EN</a>
						<a class="dropdown-item" href="{{ route(Route::currentRouteName(), 'tm') }}" style="color: #1ED760; ">TM</a>
					</div>
